...
(custom-set-variables
 ...
 '(package-selected-packages
   '(smartparens nix-mode which-key visual-fill-column typescript-mode rainbow-delimiters python-mode org-bullets lsp-ui lsp-ivy ivy-rich helpful general forge doom-themes doom-modeline dap-mode counsel-projectile company-box all-the-icons)))
(custom-set-faces
