...
The following provides language server support for Python using pylsp. I'm still unsure of how to make this work both on my Debian WSL and my NixOS machines.
