...
I need TRAMP to work really well as I mostly work directly on the university cluster. For that, I need the remote shell to evaluate my shell profile (to setup the PATH correctly).
